...
- **This repository**: [github.com/nirholas/Binance-US-MCP](https://github.com/nirholas/Binance-US-MCP). The SperaxOS marketplace listing is offline while its hosting is being migrated.
- **The full MCP catalog**: see [modelcontextprotocol.name](https://modelcontextprotocol.name)

> Powered by [modelcontextprotocol.name](https://modelcontextprotocol.name) — the open MCP HTTP gateway

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=nirholas/Binance-US-MCP&type=Date)](https://star-history.com/#nirholas/Binance-US-MCP&Date)
